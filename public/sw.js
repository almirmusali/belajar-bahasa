...
//    Держится на том, что адрес меняется вместе с содержимым: у сборочных файлов
//    Next хеш в имени, у обложек и иллюстраций книг — хеш в query (см. coverUrl
//    и chapterIllustrationUrl в lib/reading.ts). Картинку с постоянным адресом и
//    меняющимся содержимым этот кеш заморозит навсегда — так и случилось с
//    обложкой «Мародёров» 27.08.2026. Добавляешь такую статику — версионируй URL.
