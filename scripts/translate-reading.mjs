...
const SENT_PROMPT_EN = `Ты переводишь на русский язык роман, написанный простым английским (уровень A2) для изучающих язык.
...
const SENT_PROMPT_ID = `Ты переводишь индонезийский детективный роман на русский язык.
...
const SENT_PROMPT = LANG === "en" ? SENT_PROMPT_EN : SENT_PROMPT_ID;
...
const WORD_PROMPT_EN = `Ты составляешь словарь к английскому роману (простой английский, уровень A2) для русскоязычного читателя.
...
const WORD_PROMPT_ID = `Ты составляешь словарь к индонезийскому роману для русскоязычного читателя.
...
const WORD_PROMPT = LANG === "en" ? WORD_PROMPT_EN : WORD_PROMPT_ID;
