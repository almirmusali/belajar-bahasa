...
const ru: Dict = {
  ...
  fc_offline_download: "Скачать озвучку набора",
  fc_offline_downloading: "Скачиваю: {done} / {total}",
  fc_offline_ready: "Озвучка скачана — работает без сети",
  fc_offline_partial: "Скачано {done} / {total} — докачать",
  fc_offline_hint: "Чтобы в машине и без интернета звучало всё",
  fc_offline_session: "Держится до перезагрузки: по http браузер не даёт постоянный кеш",
...
const id: Dict = {
  ...
  fc_offline_download: "Unduh suara set ini",
  fc_offline_downloading: "Mengunduh: {done} / {total}",
  fc_offline_ready: "Suara sudah diunduh — jalan tanpa internet",
  fc_offline_partial: "Terunduh {done} / {total} — lanjutkan",
  fc_offline_hint: "Agar semuanya terdengar di mobil dan tanpa internet",
  fc_offline_session: "Bertahan sampai halaman dimuat ulang: lewat http browser tidak memberi cache permanen",
